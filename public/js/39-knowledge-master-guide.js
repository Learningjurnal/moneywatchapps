...
(function(window, document) {
  ...
  function renderConvictionTab() {
    return ''
      ...
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 1. Market Regime IHSG berstatus Bullish atau Netral.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 2. Valuasi Harga Wajar (DCF/Graham) memiliki Margin of Safety &gt; 10%.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 3. Rasio Profitabilitas ROE &gt; 12% dan DER &lt; 1.2x.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 4. Struktur Tren Harga berada di atas EMA20 dan EMA50.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 5. TradeWave mengonfirmasi sinyal BUY atau Impulse Wave 3.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 6. Volume transaksi &gt; 1.2x rata-rata 20 hari saat kenaikan harga.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 7. Chaikin Money Flow (CMF-20) berada di teritori positif (&gt; 0).</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 8. Top 3 Broker mencatat akumulasi bersih dominan.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 9. Rasio Risk : Reward terukur minimal 1 : 2.0.</div>'
      + '      <div style="background:var(--bg3);padding:8px 12px;border-radius:6px;border:1px solid var(--border)">✅ 10. Memiliki Tesis Investasi tertulis dan batas Invalidation Stop Loss.</div>'
      + '    </div>'
      + '  </div>'
      + '</div>';
  }
