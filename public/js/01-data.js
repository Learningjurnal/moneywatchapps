...
var _IDX_RAW_LIST = {
  ...
  // FIX (2026-09-26, user-provided real source: official IDX Stock
  // Screener export 26 Sep 2026, "IDX-Stock-Screener-26Sep2026.xlsx") —
  // 7 tickers Invezgo's live top accumulation/distribution scan can
  // return that were entirely missing here, discovered via the "Lainnya"
  // sector-bucket diagnostic added earlier this session. Sector field
  // here is 'Lainnya' by this file's own established convention (same as
  // every other entry above) — the real sector comes from
  // IDX_SECTOR_GROUPS/IDX_SECTOR_MAP below, verified against the xlsx's
  // own Sector/Subsector/Industry columns, not guessed. base:0 (not a
  // placeholder price) per the same honest convention documented at
  // 14-admin.js: no fabricated starting price, real price comes from a
  // live Yahoo/Invezgo fetch. FREN was already correctly present in
  // IDX_SECTOR_GROUPS' Infrastructures array but never had a DB entry,
  // so it never became a key in loadBaseUniverse()'s combined universe —
  // added here too so it actually resolves.
  'BACH':{name:'Bach Multi Global Tbk.',base:0,sector:'Lainnya',beta:1.0},
  'EMMI':{name:'Esa Medika Mandiri Tbk.',base:0,sector:'Lainnya',beta:1.0},
  'FREN':{name:'Smartfren Telecom Tbk',base:0,sector:'Lainnya',beta:1.0},
  'GOTOM':{name:'MVS GoTo Gojek Tokopedia Tbk.',base:0,sector:'Lainnya',beta:1.0},
  'JECX':{name:'Nitrasanata Dharma Tbk.',base:0,sector:'Lainnya',beta:1.0},
  'JELI':{name:'Niramas Utama Tbk.',base:0,sector:'Lainnya',beta:1.0},
...
var IDX_SECTOR_GROUPS = {
  ...
  "Consumer Cyclicals (Konsumer Non-Primer)": ["CINT","OBMD","ACES","MAPI","MAPA","ERAA","RALS","LPPF","AUTO","DRMA","SMSM","ASLC","GJTL","WIFI","BMTR","MNCN","SCMA","ABBA","AGAR","AKKU","ARGO","ARTA","BATA","BAYU","BELL","BIMA","BLTZ","BOLA","BOGA","BOBA","CSAP","CSMI","DAYA","DFAM","DIGI","DOOH","EAST","ECII","ERTX","ESTA","FILM","GLOB","GWAB","HERO","HRTA","IDEA","IMAS","INDS","JGLE","KDTN","KPIG","LFLO","LUCY","MAPB","MARI","MDIA","MGLV","MINA","MSIN","NETV","PANR","PDES","PJAA","PLAN","PMJS","PNSE","POLI","RAAM","RANC","RICY","RUNS","SHID","SNLK","SONA","SOST","SOTS","SPMT","TALF","TELE","TOOL","TOPS","TOSK","TYRE","VAST","VERN","VIVA","VTNY","ZONE","ESTI","HOTL","LPLI","MDRN","MLPL","MPMX","PBRX","SRIL","TRIS","FAST","PZZA","TRIO","WOOD","CNTX","IMJS","SSTM","ENAK","RANS"],
  "Healthcare (Kesehatan)": ["SOHO","PEHA","KLBF","SIDO","MIKA","HEAL","SILO","PRDA","TSPC","IRRA","KAEF","INAF","SAME","CARE","DVLA","MERK","OMED","PRAY","PYFA","RSGK","SRAJ","EPMT","MEDS","HALO","BMHS","DGNS","SCPI","VICI","MMIX","RSCH","HYGN","LABS","OBAT","DKHH","CHEK","EMMI","JECX"],
  "Technology (Teknologi)": ["GOTO","BUKA","EMTK","WIRG","BELI","MTDL","DCII","MLPT","MCAS","DMMX","AREA","ATIC","AWAN","AXIO","CHIP","CYBR","DIVA","DNET","GLVA","HDIT","IRSX","JAST","KIOS","KREN","LUCK","METO","NFCX","PACK","PTSN","SKYB","TECH","TFAS","TRON","UVCR","WGSH","ZYRX","ASGR","LMAS","ENVY","EDGE","BUVA","INOV","NANO","NINE","JATI","VKTR","MSTI","BATR","DOSS","MENN","GOTOM"],
