...
tidak lewat sidebar utama). 3 halaman (`sektoral`, `stockmaster`, `copilot`,
`dataconn` — total 3 bukan 4, `stockmaster`+2 lainnya) **terkonfirmasi tidak
punya jalan masuk navigasi apa pun** dan butuh keputusan produk eksplisit.
