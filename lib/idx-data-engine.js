...
function getIdxCalendarData(filters = {}) {
  const allDividends = [
    { code: 'BBRI', name: 'Bank Rakyat Indonesia (Persero) Tbk.', cumDate: '2026-09-08', exDate: '2026-09-09', recDate: '2026-09-10', paymentDate: '2026-09-26', dps: 185.0, yield: 5.5, payoutRatio: '72%', status: 'Mendatang', type: 'Interim / Final' },
    { code: 'BBCA', name: 'Bank Central Asia Tbk.', cumDate: '2026-09-15', exDate: '2026-09-16', recDate: '2026-09-17', paymentDate: '2026-10-04', dps: 120.0, yield: 1.8, payoutRatio: '65%', status: 'Mendatang', type: 'Interim' },
    { code: 'ADRO', name: 'Alamtri Resources Indonesia Tbk.', cumDate: '2026-09-22', exDate: '2026-09-23', recDate: '2026-09-24', paymentDate: '2026-10-12', dps: 310.0, yield: 11.1, payoutRatio: '85%', status: 'Mendatang', type: 'Final' },
    { code: 'ASII', name: 'Astra International Tbk.', cumDate: '2026-10-02', exDate: '2026-10-03', recDate: '2026-10-04', paymentDate: '2026-10-24', dps: 240.0, yield: 4.8, payoutRatio: '60%', status: 'Mendatang', type: 'Interim' },
    { code: 'TLKM', name: 'Telkom Indonesia (Persero) Tbk.', cumDate: '2026-10-10', exDate: '2026-10-11', recDate: '2026-10-12', paymentDate: '2026-11-01', dps: 145.0, yield: 5.5, payoutRatio: '75%', status: 'Mendatang', type: 'Final' },
    ...
    { code: 'UNVR', name: 'Unilever Indonesia Tbk.', cumDate: '2026-10-18', exDate: '2026-10-19', recDate: '2026-10-20', paymentDate: '2026-11-08', dps: 77.0, yield: 3.8, payoutRatio: '95%', status: 'Mendatang', type: 'Interim' },
    { code: 'PTBA', name: 'Bukit Asam Tbk.', cumDate: '2026-10-25', exDate: '2026-10-26', recDate: '2026-10-27', paymentDate: '2026-11-15', dps: 380.0, yield: 13.5, payoutRatio: '90%', status: 'Mendatang', type: 'Final' },
    { code: 'ITMG', name: 'Indo Tambangraya Megah Tbk.', cumDate: '2026-09-12', exDate: '2026-09-13', recDate: '2026-09-14', paymentDate: '2026-09-30', dps: 1750.0, yield: 12.2, payoutRatio: '70%', status: 'Mendatang', type: 'Interim' },
    { code: 'BMRI', name: 'Bank Mandiri (Persero) Tbk.', cumDate: '2026-10-28', exDate: '2026-10-29', recDate: '2026-10-30', paymentDate: '2026-11-18', dps: 340.0, yield: 5.8, payoutRatio: '60%', status: 'Mendatang', type: 'Final' },
    { code: 'BBNI', name: 'Bank Negara Indonesia (Persero) Tbk.', cumDate: '2026-11-04', exDate: '2026-11-05', recDate: '2026-11-06', paymentDate: '2026-11-25', dps: 280.0, yield: 5.6, payoutRatio: '50%', status: 'Mendatang', type: 'Final' },
    { code: 'PGAS', name: 'Perusahaan Gas Negara Tbk.', cumDate: '2026-11-12', exDate: '2026-11-13', recDate: '2026-11-14', paymentDate: '2026-12-02', dps: 125.0, yield: 8.4, payoutRatio: '70%', status: 'Mendatang', type: 'Final' },
    { code: 'ICBP', name: 'Indofood CBP Sukses Makmur Tbk.', cumDate: '2026-09-18', exDate: '2026-09-19', recDate: '2026-09-22', paymentDate: '2026-10-09', dps: 215.0, yield: 2.1, payoutRatio: '40%', status: 'Mendatang', type: 'Final' },
    { code: 'INDF', name: 'Indofood Sukses Makmur Tbk.', cumDate: '2026-09-18', exDate: '2026-09-19', recDate: '2026-09-22', paymentDate: '2026-10-09', dps: 260.0, yield: 4.1, payoutRatio: '45%', status: 'Mendatang', type: 'Final' }
  ];
