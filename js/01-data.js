...
var DB = {
  ...
  'GGRM':{name:'Gudang Garam Tbk.',base:14250,sector:'Konsumer Non-Primer',beta:0.85},
  'PGEO':{name:'Pertamina Geothermal Energy Tbk.',base:1220,sector:'Energi',beta:1.10},
  'ARCI':{name:'Archi Indonesia Tbk.',base:420,sector:'Barang Baku',beta:1.25},
  'CDIA':{name:'Chandra Daya Investasi Tbk.',base:1950,sector:'Infrastruktur',beta:1.05},
  'ADMR':{name:'Alamtri Minerals Indonesia Tbk.',base:1680,sector:'Barang Baku',beta:1.30},
  'WIFI':{name:'Solusi Sinergi Digital Tbk.',base:2060,sector:'Teknologi',beta:1.40},
  'RAJA':{name:'Rukun Raharja Tbk.',base:1070,sector:'Energi',beta:1.15},
  'SMDR':{name:'Samudera Indonesia Tbk.',base:420,sector:'Transportation & Logistic',beta:1.10},
  'ERAA':{name:'Erajaya Swasembada Tbk.',base:440,sector:'Konsumer Non-Primer',beta:1.05},
  'BUMI':{name:'Bumi Resources Tbk.',base:194,sector:'Energi',beta:1.65},
  'MBMA':{name:'Merdeka Battery Materials Tbk.',base:650,sector:'Barang Baku',beta:1.35},
  'DEWA':{name:'Darma Henwa Tbk.',base:95,sector:'Energi',beta:1.45},
  'AADI':{name:'Adaro Andalan Indonesia Tbk.',base:9850,sector:'Energi',beta:1.20},
  'PTRO':{name:'Petrosea Tbk.',base:5125,sector:'Perindustrian',beta:1.30},
  'PMMP':{name:'Panca Mitra Multiperdana Tbk.',base:260,sector:'Konsumer Primer',beta:1.10},
  'PRDL':{name:'Pratama Abadi Nusa Tbk.',base:356,sector:'Transportation & Logistic',beta:1.00},
  'GMFI':{name:'Garuda Maintenance Facility AeroAsia Tbk.',base:64,sector:'Transportation & Logistic',beta:1.15},
  'CPRI':{name:'Capri Nusa Satu Properti Tbk.',base:123,sector:'Properti',beta:1.00},
