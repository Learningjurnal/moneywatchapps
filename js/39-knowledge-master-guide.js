...
(function(window, document) {
  ...
  function renderToolbarsTab() {
    return ''
      ...
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:var(--green);margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-briefcase"></i> 1. Toolbar Portofolio &amp; Aset'
      + '      </div>'
      ...
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'portofolio\')">Saham Indonesia</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'crypto\')">Crypto</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'etf\')">ETF Global</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'reksadana\')">Reksa Dana</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'performance\')">TWR Chart</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'dividen\')">Dividen</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'rebalance\')">Rebalance</button>'
      + '      </div>'
      + '    </div>'

      // GROUP 2: RISET & INTELIJEN
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:#38bdf8;margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-microscope"></i> 2. Toolbar Riset &amp; Intelijen'
      + '      </div>'
      + '      <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-bottom:10px">'
      ...
      + '      </div>'
      + '      <div style="display:flex;gap:6px;flex-wrap:wrap">'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'stock-intel\')">Stock Intelligence</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'tradewave\')">TradeWave PRO</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="openKseiModal()">Kepemilikan KSEI</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'fundamental\')">Fundamental</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'technical\')">Technical Flow</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'hargawajar\')">Harga Wajar</button>'
      + '      </div>'
      + '    </div>'

      // GROUP 3: PASAR & ALERTS
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:var(--amber);margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-world"></i> 3. Toolbar Pasar &amp; Alerts'
      + '      </div>'
      + '      <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-bottom:10px">'
      ...
      + '      </div>'
      + '      <div style="display:flex;gap:6px;flex-wrap:wrap">'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'market-regime\')">Market Regime</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'radar\')">Opportunity Radar</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'heatmap\')">Heatmap</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'ranking\')">Rankings</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'alerts\')">Price Alerts</button>'
      + '      </div>'
      + '    </div>'

      // GROUP 4: QUANT & SIMULASI
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:var(--accent);margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-brain"></i> 4. Toolbar Quant &amp; Simulasi'
      + '      </div>'
      + '      <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-bottom:10px">'
      ...
      + '      </div>'
      + '      <div style="display:flex;gap:6px;flex-wrap:wrap">'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'scenario\')">Scenario Engine</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'correlation\')">Correlation Matrix</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'backtester\')">Backtester</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'monthly-returns\')">Seasonality</button>'
      + '      </div>'
      + '    </div>'
      ...
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:#38bdf8;margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-sparkles"></i> 5. Toolbar AI Intelligence'
      + '      </div>'
      + '      <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-bottom:10px">'
      ...
      + '      </div>'
      + '      <div style="display:flex;gap:6px;flex-wrap:wrap">'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'ai-trading\')">AI Trading Engine</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'copilot\')">AI Copilot</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'thesis\')">Investment Thesis</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'journal\')">Decision Journal</button>'
      + '      </div>'
      + '    </div>'
      ...
      + '    <div style="background:var(--bg3);border:1px solid var(--border2);border-radius:8px;padding:16px">'
      + '      <div style="font-size:14px;font-weight:800;color:var(--accent);margin-bottom:6px;display:flex;align-items:center;gap:6px">'
      + '        <i class="ti ti-diamond"></i> 6. Toolbar Wealth &amp; Pajak'
      + '      </div>'
      + '      <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-bottom:10px">'
      ...
      + '      </div>'
      + '      <div style="display:flex;gap:6px;flex-wrap:wrap">'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'wealth\')">Net Worth</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'rdn\')">Kas &amp; Mutasi RDN</button>'
      + '        <button class="btn btn-ghost btn-xs" onclick="goPage(\'pajak\')">Pajak &amp; SPT</button>'
      + '      </div>'
      + '    </div>'
