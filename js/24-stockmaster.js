...
function fundRenderAcademicSynthesis(curPrice, eps, bvps, roe, payout, per, pbv, dps, rev, revG, gm, om, pm, dte, cr, ocf, mcap, sector, ticker, fairPriceMoS, mosPct, grahamVal, grahamDiff, lynchVal, lynchDiff, ddmVal, ddmDiff) {
  ...
  tableEl.innerHTML = ''
    + '<tr>'
    + '  <td style="font-weight:700;color:var(--text)">1. Konsensus Valuasi &amp; Margin of Safety<br><span style="font-size:10px;color:var(--text3);font-weight:400">Rata-rata 4 Model Valuasi vs Harga Pasar</span></td>'
    + '  <td style="color:var(--text2)">Buffett 9-Step, Graham <code style="color:#60A5FA">√(22.5×E×B)</code>, Lynch PEG 1.0, dan DDM</td>'
    + '  <td style="font-family:Fira Code,monospace;font-weight:700;color:' + (consensusMoSPct >= 0 ? '#10B981' : '#EF4444') + '">Nilai Wajar: Rp ' + Math.round(consensusFairPrice).toLocaleString('id-ID') + '<br><span style="font-size:10px;color:var(--text3);font-weight:400">Harga Pasar: Rp ' + Math.round(curPrice).toLocaleString('id-ID') + ' (MoS: ' + (consensusMoSPct >= 0 ? '+' : '') + consensusMoSPct.toFixed(1) + '%)</span></td>'
    ...
    + '</tr>'
    + '<tr>'
    + '  <td style="font-weight:700;color:var(--text)">2. Efisiensi Modal &amp; Profitabilitas Laba<br><span style="font-size:10px;color:var(--text3);font-weight:400">Tingkat Pengembalian atas Ekuitas Bersih</span></td>'
    + '  <td style="color:var(--text2)">ROE = Laba Bersih / Ekuitas | Target Sehat: ROE &ge; 12.0%, NPM &gt; 10%</td>'
    + '  <td style="font-family:Fira Code,monospace;font-weight:700;color:' + (roe >= 0.12 ? '#10B981' : '#60A5FA') + '">ROE: ' + (roe * 100).toFixed(1) + '% | NPM: ' + (pm * 100).toFixed(1) + '%<br><span style="font-size:10px;color:var(--text3);font-weight:400">EPS: Rp ' + Math.round(eps) + ' / saham</span></td>'
    ...
    + '</tr>'
    + '<tr>'
    + '  <td style="font-weight:700;color:var(--text)">3. Keunggulan Margin &amp; Pricing Power<br><span style="font-size:10px;color:var(--text3);font-weight:400">Daya Saing Produk &amp; Margin Operasional</span></td>'
    + '  <td style="color:var(--text2)">Gross Margin = (Pendapatan - COGS) / Pendapatan | Oper. Margin</td>'
    + '  <td style="font-family:Fira Code,monospace;font-weight:700;color:' + (gm >= 0.35 ? '#10B981' : '#60A5FA') + '">Gross Margin: ' + (gm * 100).toFixed(1) + '%<br><span style="font-size:10px;color:var(--text3);font-weight:400">Operating Margin: ' + (om * 100).toFixed(1) + '%</span></td>'
    ...
    + '</tr>'
    + '<tr>'
    + '  <td style="font-weight:700;color:var(--text)">4. Solvabilitas &amp; Struktur Permodalan<br><span style="font-size:10px;color:var(--text3);font-weight:400">Tingkat Utang &amp; Ketahanan Likuiditas</span></td>'
    + '  <td style="color:var(--text2)">DER = Total Utang / Ekuitas (Target &lt; 1.5x) | Current Ratio &gt; 1.1x</td>'
    + '  <td style="font-family:Fira Code,monospace;font-weight:700;color:' + (dte <= 1.2 ? '#10B981' : (dte <= 2.0 ? '#60A5FA' : '#EF4444')) + '">DER: ' + dte.toFixed(2) + 'x | Likuiditas: ' + cr.toFixed(2) + 'x<br><span style="font-size:10px;color:var(--text3);font-weight:400">BVPS: Rp ' + Math.round(bvps) + ' | PBV: ' + pbv.toFixed(2) + 'x</span></td>'
    ...
    + '</tr>'
    + '<tr>'
    + '  <td style="font-weight:700;color:var(--text)">5. Kualitas Arus Kas &amp; Pembagian Dividen<br><span style="font-size:10px;color:var(--text3);font-weight:400">Realisasi Kas Operasi vs Laba Akrual</span></td>'
    + '  <td style="color:var(--text2)">Operating Cash Flow (OCF) &gt; 0, Dividend Yield &amp; Payout Ratio</td>'
    + '  <td style="font-family:Fira Code,monospace;font-weight:700;color:' + (isOcfPositive ? '#10B981' : '#EF4444') + '">OCF: Rp ' + fundFmt(ocf) + '<br><span style="font-size:10px;color:var(--text3);font-weight:400">Dividend Yield: ' + ((dps / Math.max(1, curPrice)) * 100).toFixed(2) + '% (DPR ' + (payout * 100).toFixed(0) + '%)</span></td>'
