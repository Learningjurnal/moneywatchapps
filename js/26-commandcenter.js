...
function renderMarketRegimePage() {
  ...
  + '<div class="card" style="margin-bottom:16px;padding:20px">'
    ...
    + '<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px">'
      + '<div style="background:rgba(255,255,255,0.02);border:1px solid var(--border2);border-radius:8px;padding:14px">'
...
function renderDataConnPage() {
  ...
  + '<div class="card" style="padding:20px;margin-bottom:16px">'
    ...
    + '<div style="display:flex;flex-direction:column;gap:12px">'
      + '<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;background:rgba(255,255,255,0.02);border:1px solid var(--border2);border-radius:8px">'
