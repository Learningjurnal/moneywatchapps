...
const nextDiv = content.indexOf('<div id="page-performance"', content.indexOf(startTag));

if (nextDiv !== -1) {
    const newContent = content.substring(0, content.indexOf(startTag) + startTag.length) + htmlContent + "\n</div>\n" + content.substring(nextDiv);
